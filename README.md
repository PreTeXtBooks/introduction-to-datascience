...
For the python version of the textbook, please visit https://python.datasciencebook.ca or the PreTeXt version at https://github.com/PreTeXtBooks/introduction-to-datascience-python
